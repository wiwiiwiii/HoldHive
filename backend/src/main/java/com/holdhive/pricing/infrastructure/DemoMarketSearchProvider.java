...
public class DemoMarketSearchProvider implements MarketSearchProvider {
    ...
    private static final List<MarketSearchItem> DEMO_CATALOG = List.of(
        ...
        new MarketSearchItem("NVDA", "NVIDIA Corp.", "NASDAQ", "EASTMONEY", "105.NVDA", AssetType.STOCK),
        ...
        new MarketSearchItem("005827", "E Fund Blue Chip Selected Mixed Fund", "FUND", "EASTMONEY", "FUND:005827", AssetType.MUTUAL_FUND),
